This implementation of an AVL tree achieves improved performance for deletion from the AVL tree via the algorithm described in the following online pre-print articles.
