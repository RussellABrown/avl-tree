This C++ implementation of an AVL tree achieves improved performance for AVL node deletion via the algorithm described in the following pre-print article.
